...
<template>
    <div class="grid md:grid-cols-4 gap-3 py-10 px-6">
        <div class="md:col-span-1 px-6 py-4 bg-teal-700 rounded-xl">
            <div class="flex space-x-4">
                <input v-model="query" type="search" placeholder="Find a job ..." class="w-full px-6 py-4 rounded-xl">

                <button 
                    class="px-6 py-4 bg-teal-900 text-white rounded-xl hover:bg-teal-950"
            ...
            <h3 class="my-4 text-white text-xl">Categories</h3>
            ...
            <div class="mt-6 space-y-4">
                ...
                v-bind:class="{'bg-teal-900 rounded-xl': selectedCategoriesRef.includes(category.id)}"
                >{{ category.title }}</p>
            </div>
        </div>
